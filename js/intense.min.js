...
var Intense = function () {
    ...
    function t(e) {
        ...
        if (e.w * n > window.innerWidth) return {
            w: e.w * n,
            h: e.h * n,
            fit: !0
        };
    ...
    function r(e) {
        (e.getAttribute("data-image") || e.src || e.href) && e.addEventListener("click", function (n) {
    ...
    function c() {
        z = document.body.style.overflow, document.body.style.overflow = "hidden"
    }
    ...
    function l(e, n) {
        if (e) e.className = e.className.replace("intense--loading", ""), e.className = e.className.replace("intense--viewing", ""), e.className += " " + n;
        else {
    ...
    function u(e, t) {
        ...
        R.appendChild(a), w(), V.xCurr = V.xDest = window.innerWidth / 2, V.yCurr = V.yDest = window.innerHeight / 2, document.body.appendChild(R), setTimeout(function () {
            R.style.opacity = "1"
        }, 10)
    }
    ...
    function w() {
        var e = t(k);
        E.width = e.w, E.height = e.h, Y = e.fit, H = {
            w: E.width,
            h: E.height
        }, N = {
            w: window.innerWidth,
    ...
    function A(e) {
        ...
        T && (T.onload = null), T = new Image, T.onload = function () {
            k = {
                w: T.width,
                h: T.height
            }, E = this, u(t, i), c(), f(), s(), l(e, "intense--viewing")
        }, T.src = n
    }

    function f() {
        R.addEventListener("mousemove", h, !1), R.addEventListener("mousemove", v, !1), window.addEventListener("resize", w, !1), window.addEventListener("keyup", g, !1), E.addEventListener("click", m, !1)
    }

    function p() {
        R.removeEventListener("mousemove", h, !1), R.removeEventListener("touchmove", v, !1), window.removeEventListener("resize", w, !1), window.removeEventListener("keyup", g, !1), E.removeEventListener("click", m, !1)
    }
    ...
    function v(e) {
        e.preventDefault(), V.xDest = window.innerWidth - e.touches[0].clientX, V.yDest = window.innerHeight - e.touches[0].clientY
    }
    ...
    function x() {
        ...
        if (V.xCurr += .0 * (V.xDest - V.xCurr), V.yCurr += .05 * (V.yDest - V.yCurr), Y === !0) {
            if (F += V.xCurr - F, V.xCurr !== C) {
                var n = parseFloat(e(F, N.w));
                n = I.x * n, E.style.webkitTransform = "translate(" + n + "px, 0px)", E.style.MozTransform = "translate(" + n + "px, 0px)", E.style.msTransform = "translate(" + n + "px, 0px)", C = V.xCurr
            }
        } else if (Y === !1 && (F += V.yCurr - F, V.yCurr !== C)) {
            var n = parseFloat(e(F, N.h));
            n = I.y * n, E.style.webkitTransform = "translate( 0px, " + n + "px)", E.style.MozTransform = "translate( 0px, " + n + "px)", E.style.msTransform = "translate( 0px, " + n + "px)", C = V.yCurr
        }
    }
